    ...
    <div class="wrap">
        ...
        <div class="col_1_of_2 span_1_of_2">
            ...
            <div>
                ...
                <br>
                <?php echo Form::input('code', Input::post('code')); ?>
        ...
        <div class="col_1_of_2 span_1_of_2">
            <div>
                ...
                <br>
                <?php echo Form::input('symbol', Input::post('symbol'), array('placeholder' => '')); ?>
                <?php echo Form::error('symbol', $err); ?>
            </div>
            <div>
                <?php echo Form::label(__('title.rate'), 'rate', array('class' => 'required')); ?>
                <br>
                <?php echo Form::input('rate', Input::post('rate'), array('placeholder' => '')); ?>
